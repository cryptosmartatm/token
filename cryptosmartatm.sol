...
/**
 * cryptosmart atm dividend token
 * 2020 by rg
 */
library SafeMath {
...
contract Token is DividendToken , PausableDividendToken {
    string public constant name = 'CryptoSmart ATM';
    string public constant symbol = 'CSATM';
        ...
        
    {
                ...
                uint premintAmount = 100000000000*10**uint(decimals);
